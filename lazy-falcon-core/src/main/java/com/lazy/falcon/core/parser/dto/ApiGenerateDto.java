...
public class ApiGenerateDto {
     ...
     * 当前项目-所有控制器Class
     */
    private List<Class<?>> nowApiModuleClasses;
    /**
     * 当前项目-ClassPath
     */
    ...
    public List<Class<?>> getNowApiModuleClasses() {
        return nowApiModuleClasses;
    }

    public void setNowApiModuleClasses(List<Class<?>> nowApiModuleClasses) {
        this.nowApiModuleClasses = nowApiModuleClasses;
    }

    public String getNowProjectClassPath() {
        return nowProjectClassPath;
    }

    public void setnowProjectClassPath(String nowProjectClassPath) {
        this.nowProjectClassPath = nowProjectClassPath;
    }
    ...
    public ApiDto getNowApiDto() {
        return nowApiDto;
    }

    public void setNowApiDto(ApiDto nowApiDto) {
